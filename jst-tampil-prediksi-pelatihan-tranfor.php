...
$sql = mysqli_query($server, "SELECT * from hasil_prediksi_jst where prediksi like '%pelatihan%'"); 
$i=1;
...
?>
                  <tbody>
                    <tr>
                      ...
                      <td><a href="?p=jst_prediksi_pelatihan_akhir&id_prediksi=<?php echo $row['id_pre']; ?>">
...
<?php $i++; } ?>
                                ...
                                <div class="from ">
              <a href="?p=jst_tampil_prediksi_pelatihan"><button type="button" class="btn btn-success">Back</button></a>
