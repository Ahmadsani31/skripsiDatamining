  ...
  $sqlPre = mysql_query("SELECT * from hasil_prediksi_jst where id_hasil='$_GET[id_prediksi]'") or die( mysql_error()); 
  $rowPre = mysql_fetch_array($sqlPre);

  $sql = mysql_query("SELECT * from prediksi_jst where id_pre='$rowPre[id_pre]'") or die( mysql_error()); 
  $row = mysql_fetch_array($sql);

  $sqldata = mysql_query("SELECT * from data where id_d='$rowPre[id_data]'") or die( mysql_error()); 
