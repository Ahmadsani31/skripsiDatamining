...
<?php $i++; } ?>
            ...
            <div class="from ">
            <button name="submit" class="btn btn-theme03">Proses Transfomasi data Pelatihan</button>
            <a href="?p=jst_tampil_pelatihan_tranfor"><button type="button" class="btn btn-primary">Lihat Transfomasi</button></a>
             </div>
                </form>
              </div>
...
//$data = $_POST['data'];
 ...
 mysql_query("DELETE FROM pelatihan")  or die (mysql_error());

for ($i=0; $i < $countID ; $i++) { 
   mysql_query("insert into pelatihan values ('','$id[$i]','$x1','$x2','$x3','$x4','$x5')")  or die (mysql_error());
}

echo "<META HTTP-EQUIV='Refresh' Content='0; URL=?p=jst_query_pelatihan'>";
