...
$sql = mysql_query("SELECT * from pelatihan_jst where id_pelatihan='$_GET[id_pelatihan]'"); 
...
?>
          ...
          <strong><h3 align="center">HASIL NILAI</h3></strong>
                ...
                <table class="table table-bordered table-striped text-center mt" >
                  <tbody >
                    <tr >
                      <th style="width: auto;">Nilai Yink</th>
...
?>
            ...
            <div class="row mt">
              <div class="col-md-8">
                <a href="?p=jst_tampil_pelatihan_tranfor"><button type="button" class="btn btn-success">Kembali</button></a>
