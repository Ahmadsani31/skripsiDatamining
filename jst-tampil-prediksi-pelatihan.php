        ...
        <h3><i class="fa fa-angle-right"></i>Data Pelatihan</h3>
          ...
          <div class="col-lg-12">
            <div class="content-panel">      
              <div class="form-panel">
                <form action="?p=jst_hasil_prediksi_pelatihan_tranfor" class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                  <div class="row">
<?php 
$sqlCek = mysqli_query($server, "SELECT * from prediksi_jst where prediksi like '%pelatihan%'"); 
$rowCek = mysqli_fetch_array($sqlCek);

                    if ($rowCek['prediksi']){ ?>
                    
                      <div class="col-md-9">
                     <h4>Data Prediksi Pelatihan</h4>
                    </div>
                    <div class="col-md-3" >
                      <a href="?p=reset_pelatihan" style="float: right;"><button type="button" class="btn btn-danger">Reset</button></a>
                    </div>
                    ...
                    <div class="col-md-3">
                      <a href="?p=jst_query_prediksi_pelatihan" style="float: right;" ><button type="button" class="btn btn-theme03">Proses Prediksi Pelatihan</button></a>
                    </div>
...
$sql = mysqli_query($server, "SELECT * from prediksi_jst where prediksi like '%pelatihan%'"); 
$i=1;
...
<?php $i++; } ?>
            ...
            <?php 
$sqlHasil = mysqli_query($server, "SELECT * from hasil_prediksi_jst where prediksi like '%pelatihan%'"); 
$rowHasil = mysqli_fetch_array($sqlHasil);


            if ($rowHasil['prediksi'] == 'pelatihan' ){ ?>

              <a href="?p=jst_tampil_prediksi_pelatihan_tranfor"><button type="button" class="btn btn-success">Lihat Prediksi Pelatihan</button></a>

              <?php }else if($rowCek['x1']){ ?>
                
            <button name="submit" class="btn btn-primary">Proses Data Prediksi Pelatihan</button>
