...
$sql = mysql_query("SELECT * from pengujian_jst where id_pengujian='$_GET[id_pengujian]'"); 
$row = mysql_fetch_array($sql);

$sqldata = mysql_query("SELECT * from data where id_d='$row[id_data]'"); 
            ...
            <div class="content-panel">      
              <div class="form-panel">
                ...
                <div class="box" style="margin: 50px 0px 80px 0px">
                  ...
                  <div class="row">
                    <div class="col-md-9">
                  <h4 class=""><u>DATA PENGUJIAN :</u></h4>
                  </div>
...
?>
          ...
          <strong><h3 align="center">HASIL NILAI</h3></strong>
                ...
                <table class="table table-bordered table-striped text-center mt" >
                  <tbody >
                    <tr >
                      <th style="width: 195px">Nilai Yink</th>
...
if ($nilai >= 0 && $nilai <= 50 ) {
  $katagori = "<font color='green'>Baik</font>";
}elseif ($nilai >= 50 && $nilai <= 100 ) {
  $katagori = "<font color='blue'>Sedang</font>";
}elseif ($nilai >= 100 && $nilai <= 200 ) {
  $katagori = "<font color='red'>Tidak Sehat</font>";
}elseif ($nilai >= 200 && $nilai <= 300 ) {
  $katagori = "Sangat Tidak Sehat";
}elseif ($nilai >= 300 ) {
  $katagori = "Berbahaya";
}
...
?>
              ...
              <h3 align="center">Perkiraan Kualitas Udara satu hari berikutnya adalah :</h3>
             <div class="box text-center">
              <h4>Nilai : <b><?php echo $nilai; ?></b> Dengan Kualitas Udara</h4><h2><b> <?php echo $katagori ?> </b></h2>
            </div><br><br><br><br>
            <div class="row mt">
              <div class="col-md-8">
                <a href="?p=jst_tampil_pengujian_tranfor"><button type="button" class="btn btn-success">Kembali</button></a>
                <a href=""><button type="button" class="btn btn-default">Print</button></a>
              </div>
              <div class="col-md-4" align="center">
                <h4><u>@CopyRights</u> PUTRI MELATI</h4>
              </div>
            </div>
              </div>
            </div>
